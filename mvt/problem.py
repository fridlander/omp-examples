...
obj = Plopper(dir_path+'/mvt.c',dir_path)

cs = CS.ConfigurationSpace(seed=1234)
p1 = CSH.CategoricalHyperparameter(name='p1', choices=[' ','#pragma omp #P3','#pragma omp target teams distribute #P3 #P5 #P9 is_device_ptr(x1, x2, y_1, y_2, A)','#pragma omp #P4'], default_value=' ')
...
cond0 = CS.InCondition(p3, p1, ['#pragma omp #P3','#pragma omp target teams distribute #P3 #P5 #P9 is_device_ptr(x1, x2, y_1, y_2, A)'])
cond1 = CS.EqualsCondition(p5, p1, '#pragma omp target teams distribute #P3 #P5 #P9 is_device_ptr(x1, x2, y_1, y_2, A)')
cond2 = CS.EqualsCondition(p9, p1, '#pragma omp target teams distribute #P3 #P5 #P9 is_device_ptr(x1, x2, y_1, y_2, A)')
...
if (obj.p2check(dir_path+'/mvt.c')): #found p2
  print("found p2")
