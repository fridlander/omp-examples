...
# define POLYBENCH_ARRAY(var) var

//2d array
# define POLYBENCH_2D_ARRAY_DECL(var,type,ANI,ANJ,ni,nj) type *var=NULL; cudaSafeCall(cudaMallocManaged((void **) &var, (ANI)*(ANJ)*(sizeof(type)),1));
...
# define POLYBENCH_1D_ARRAY_DECL(var,type,ANI,ni) type *var=NULL; cudaSafeCall(cudaMallocManaged((void **) &var, (ANI)*(sizeof(type)),1));
# define POLYBENCH_1D(var, dim1, ddim1) *var
# define POLYBENCH_1D_REF(var, dim1, i) var[i]

//make one for 3d array
# define POLYBENCH_3D_ARRAY_DECL(var,type,ANI,ANJ,ANK,ni,nj,nk) type *var=NULL; cudaSafeCall(cudaMallocManaged((void **) &var, (ANI)*(ANJ)*(ANK)*(sizeof(type)),1));
